/**
 * Mobile Home Quote Configuration
 * ================================
 * Step definitions and validation for mobile/manufactured home quotes.
 */
...
export const mobileHomeSteps: StepConfig[] = [
  ...
  },
  {
    ...
    requiredFields: ['propertyAddress', 'propertyCity', 'propertyState', 'propertyZip', 'yearBuilt'],
  },
  {
    id: 'details',
    title: 'Details',
    description: 'Home specifications',
    icon: Wrench,
    validate: validateDetails,
    requiredFields: ['constructionType'],
  },
  {
    id: 'homeCoverage',
    title: 'Coverage',
...
export default mobileHomeSteps;
