...
export function ChangeFormStep() {
  const { formData, updateField, updateNestedField, errors } = useServiceRequestWizard();
        ...
        return (
          <div className="space-y-6">
            <FormSection icon={Car} title="Vehicle Removal">
              ...
              <WarningBox>
                If this is the only vehicle on the policy, the policy may need to be cancelled or
                replaced.
              </WarningBox>
            </FormSection>
          </div>
