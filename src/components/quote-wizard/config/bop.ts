/**
 * Business Owner's Policy (BOP) Configuration
 * ============================================
 * Step definitions and validation for BOP quotes.
 */

import { User, Building, Briefcase, Shield, ClipboardCheck } from 'lucide-react';
...
export const bopSteps: StepConfig[] = [
  ...
  },
  {
    ...
    requiredFields: ['businessName', 'businessType', 'yearsInBusiness', 'annualRevenue'],
  },
  {
    id: 'location',
    title: 'Location',
