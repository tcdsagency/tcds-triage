...
import ManualServiceTicketModal from '@/components/features/ManualServiceTicketModal';
...
export default function PendingReviewPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 flex-shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg font-medium transition-colors bg-green-600 hover:bg-green-700 text-white flex items-center gap-2"
          >
      ...
      {/* Manual Service Ticket Modal */}
      {pipelineData && (
        <ManualServiceTicketModal
          isOpen={showManualTicketModal}
          onClose={() => setShowManualTicketModal(false)}
          onSuccess={() => {
            fetchPipelineData();
            toast.success('Service ticket created successfully');
          }}
